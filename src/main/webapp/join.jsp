...
<script>
    ...
    function onClick() {
        document.querySelector('.mw1').style.display ='block';
        document.querySelector('.mbg1').style.display ='block';
    }   
    function offClick() {
        document.querySelector('.mw1').style.display ='none';
        document.querySelector('.mbg1').style.display ='none';
    }
    function onClick2() {
        document.querySelector('.mw2').style.display ='block';
        document.querySelector('.mbg2').style.display ='block';
    }   
    function offClick2() {
        document.querySelector('.mw2').style.display ='none';
        document.querySelector('.mbg2').style.display ='none';
    }
 
    document.getElementById('mbt1').addEventListener('click', onClick);
    document.querySelector('.mc1').addEventListener('click', offClick);
    document.getElementById('mbt2').addEventListener('click', onClick2);
    document.querySelector('.mc2').addEventListener('click', offClick2);
};
function idon(){
                ...
                <div class="join_box">
                    ...
                    <div class="consent">
                        <div>
                            <input type="checkbox">
                            <p> 개인정보 수집 이용 동의</p>
                            <button type='button' id="mbt1"><i class="fa-solid fa-list"></i>약관 전문 보기</button>
                            <div class="black_bg mbg1"></div>
                            <div class="modal_wrap mw1">
                                <div class="modal_close mc1"><a href="#">close</a></div>
                                <div class="modal">
                                    <div class="region_select">
                                        <h1>개인정보 수집 이용 동의 약관</h1>
                                    </div>
                                    <div class="textarea">
                        ...
                        <div>
                            <input type="checkbox">
                            <p>개인정보 제3자 제공 동의</p>
                            <button type="button" id="mbt2"><i class="fa-solid fa-list"></i>약관 전문 보기</button>
                            <div class="black_bg mbg2"></div>
                            <div class="modal_wrap mw2">
                                <div class="modal_close mc2"><a href="#">close</a></div>
                                <div class="modal">
                                    <div class="region_select">
                                        <h1>개인정보 제3자 제공 동의 약관</h1>
                                    </div>
                                    <div class="textarea">
                                        <p>여러분을 환영합니다.
